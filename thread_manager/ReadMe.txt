========================================================================
    СТАТИЧЕСКАЯ БИБЛИОТЕКА. Обзор проекта thread_manager
========================================================================

Этот проект библиотеки thread_manager создан автоматически с помощью мастера приложений.

В составе проекта не созданы исходные файлы.


thread_manager.vcxproj
...
thread_manager.vcxproj.filters
